...
public class DriveSlow extends SubsystemBase {
  ...
  public DriveSlow() {
    ...
    leftMotorMaster.setSmartCurrentLimit(Constants.SLOW_STALL_LIMIT_DRIVE, Constants.SLOW_FREE_LIMIT_DRIVE);
    leftMotorFollower.setSmartCurrentLimit(Constants.SLOW_STALL_LIMIT_DRIVE, Constants.SLOW_FREE_LIMIT_DRIVE);

    rightMotorMaster.setSmartCurrentLimit(Constants.SLOW_STALL_LIMIT_DRIVE, Constants.SLOW_FREE_LIMIT_DRIVE);
    rightMotorFollower.setSmartCurrentLimit(Constants.SLOW_STALL_LIMIT_DRIVE, Constants.SLOW_FREE_LIMIT_DRIVE);
